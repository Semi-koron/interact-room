...
export const ITEM_DEFS: Map<number, ItemDef> = new Map([
  ...
  [102, { id: 1, name: "Wood", objectId: 101, ingredients: [901] }], // Duplicate for testing
  [103, { id: 2, name: "Stone", objectId: 102, ingredients: [] }],
  [104, { id: 3, name: "Iron Ore", objectId: 103, ingredients: [] }],
  [105, { id: 4, name: "Sand", objectId: 104, ingredients: [] }],
  [106, { id: 5, name: "Cotton", objectId: 105, ingredients: [] }],
